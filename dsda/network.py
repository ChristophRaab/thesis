...
from dda.adversarial.asan.spectral_normalization import SpectralNorm
...
class SNAdversarialNetwork(nn.Module): # Discriminator
  def __init__(self, in_feature, hidden_size):
    super(SNAdversarialNetwork, self).__init__()
  ...
  def output_num(self):
    return 1
  def get_parameters(self):
    return [{"params":self.parameters(), "lr_mult":20, 'decay_mult':2}]
